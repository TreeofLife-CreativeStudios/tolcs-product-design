...
- Assistive and creative tools
- Physical product concepts
- Mechanical and electromechanical prototypes
- Manufacturing-ready product development
- Future hardware and interactive objects

## Repository structure

Each product is maintained in a private development repository with a separate public showcase. The private repository may contain complete design work, technical research, and prototype documentation. The public showcase contains only approved concept images, generalized descriptions, and milestones.
